...
public class DoctorAddForm extends JDialog {
    ...
    public DoctorAddForm(JFrame parent, DoctorView doctorView) {
        ...
        JLabel lblTitle = new JLabel("THÊM BÁC SĨ", SwingConstants.CENTER);
        ...
        btnSave.addActionListener(e -> insertDoctor());
    ...
    private void insertDoctor() {
        try {
            ...
            boolean result = doctorController.insertDoctor(doctor);
            if (result) {
