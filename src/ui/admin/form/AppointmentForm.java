...
public class AppointmentForm extends JDialog {
    ...
    public void eventPatient() {
        ...
        cboPatient.addActionListener(e -> {
            ...
            String patient =
                    (String)
                            cboPatient.getSelectedItem();

            txtEmail.setText(
                    userController
                            .getPatientEmailByFullName(
                                    patient
                            )
            );
    ...
    public void eventDoctor() {
        ...
        cboDoctor.addActionListener(e -> {
            ...
            String doctor =
                    (String)
                            cboDoctor.getSelectedItem();

            idDoctor =
                    doctorController
                            .getDoctorIdByFullName(
                                    doctor
                            );
        });
    }
